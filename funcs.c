...
/**
 * _append_hexa_code - Append ascci in hexadecimal code to buffer
...
/**
 * _convert_size_unsgnd - Casts a number to the specified size
...
/**
 * _convert_size_number - Casts a number to the specified size
 * @num: Number to be casted.
 * @size: Number indicating the type to be casted.
 *
 * Return: Casted value of num
